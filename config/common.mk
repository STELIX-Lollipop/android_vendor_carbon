...
# SuperSU
PRODUCT_COPY_FILES += \
    vendor/stelix/prebuilt/common/UPDATE-SuperSU.zip:system/addon.d/UPDATE-SuperSU.zip \
    vendor/stelix/prebuilt/common/etc/init.d/99SuperSUDaemon:system/etc/init.d/99SuperSUDaemon
...
# Set Carbon version
ifdef CARBON_RELEASE
    STELIX_VERSION := "STELIX_"$(STELIX_VERSION_MAJOR).$(STELIX_VERSION_MINOR)-$(CARBON_BUILDTYPE)-$(shell date +%Y%m%d-%H%M)
else
    STELIX_VERSION := "STELIX_"$(STELIX_VERSION_MAJOR)-$(CARBON_BUILDTYPE)-$(shell date +%Y%m%d-%H%M)
endif
